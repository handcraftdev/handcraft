...
export default function LibraryPage() {
  ...
  // Build owned bundles list - deduplicate by bundleId
  const ownedBundles = useMemo(() => {
    ...
    // Deduplicate - count how many of each bundle the user owns and store first NFT name
    const countMap = new Map<string, number>();
