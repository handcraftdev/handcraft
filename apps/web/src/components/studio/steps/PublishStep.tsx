...
export function PublishStep({ draft, onPublish, isPublishing: externalPublishing, error, isEditMode = false, onSaveEdit }: PublishStepProps) {
  ...
  if (isEditMode) {
    return (
      <div className="max-w-2xl mx-auto">
        <h2 className="text-2xl font-medium text-white/90 mb-2">Save Changes</h2>
        <p className="text-white/40 mb-8">Update your content metadata on IPFS and blockchain</p>
        ...
        {error && (
          <div className="mb-6 bg-red-500/10 border border-red-500/20 rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-red-400 font-medium mb-1">Save failed</h4>
        ...
        <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-6 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-white/90 font-medium mb-2">Ready to Save</h4>
        ...
        <button
          ...
          className="w-full py-3 bg-purple-500/20 hover:bg-purple-500/30 disabled:opacity-30 rounded-xl font-medium transition-all border border-purple-500/30 hover:border-purple-500/50 text-white/90"
        >
  ...
  if (draft?.status === 'scheduled') {
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center py-8 mb-8 bg-amber-500/10 border border-amber-500/20 rounded-xl">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber-500/20 flex items-center justify-center">
            <svg className="w-8 h-8 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h2 className="text-2xl font-medium text-white/90 mb-2">Publication Scheduled</h2>
        ...
        {/* Reschedule Options */}
        <h3 className="text-lg font-medium text-white/90 mb-4">Change Publication Time</h3>

        <div className="space-y-4 mb-6">
          <div>
            <label className="block text-sm font-medium mb-2 text-white/70">New Date & Time</label>
            <input
              type="datetime-local"
              min={minDateTime}
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-amber-500/50 text-white/90 [color-scheme:dark] cursor-pointer"
            />
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={isPublishing}
            className="flex-1 py-3 bg-purple-500/20 hover:bg-purple-500/30 disabled:opacity-30 rounded-xl font-medium transition-all border border-purple-500/30 hover:border-purple-500/50 text-white/90"
          >
          ...
          <button
            ...
            className="flex-1 py-3 bg-amber-500/20 hover:bg-amber-500/30 disabled:opacity-30 rounded-xl font-medium transition-all border border-amber-500/30 hover:border-amber-500/50 text-white/90"
          >
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-medium text-white/90 mb-2">Publish</h2>
      <p className="text-white/40 mb-8">Choose when to publish your content</p>
      ...
      {error && (
        <div className="mb-6 bg-red-500/10 border border-red-500/20 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-red-400 font-medium mb-1">Publishing failed</h4>
              <p className="text-sm text-red-300/70">{error}</p>
            </div>
          </div>
        </div>
      ...
      {publishMode === null && (
        <div className="space-y-4">
          <button
            ...
            className="w-full p-6 bg-white/[0.02] border border-white/10 hover:border-purple-500/50 rounded-xl text-left transition-all group"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-white/90 mb-1">Publish Now</h3>
                <p className="text-sm text-white/50">
          ...
          <button
            ...
            className="w-full p-6 bg-white/[0.02] border border-white/10 hover:border-amber-500/50 rounded-xl text-left transition-all group"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-white/90 mb-1">Schedule for Later</h3>
                <p className="text-sm text-white/50">
        ...
        <div className="space-y-6">
          <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white/90 font-medium mb-2">Ready to Publish</h4>
                <p className="text-sm text-white/50">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-3 bg-white/5 hover:bg-white/10 rounded-xl font-medium transition-all border border-white/10 text-white/70"
            >
              Back
            </button>
            <button
        ...
        <div className="space-y-6">
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white/90 font-medium mb-2">How Scheduled Publishing Works</h4>
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-white/70">Schedule Date & Time</label>
            <input
              type="datetime-local"
              min={minDateTime}
              value={scheduleDateTime}
