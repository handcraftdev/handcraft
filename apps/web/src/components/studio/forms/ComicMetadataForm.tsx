  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Series</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Issue Number</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Writer</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Colorist</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Publisher</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Page Count</label>
          <input
            type="number"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Reading Direction</label>
          <select
