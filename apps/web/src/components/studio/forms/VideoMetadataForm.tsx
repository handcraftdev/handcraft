    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1.5 text-white/70">Director</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5 text-white/70">Year</label>
            <input
              type="number"
              value={metadata.year || ''}
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Cast</label>
          <input
            type="text"
            value={metadata.cast || ''}
  ...
  if (contentType === 2) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1.5 text-white/70">Season</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5 text-white/70">Episode</label>
            <input
              type="number"
