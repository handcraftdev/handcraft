...
export function GameMetadataForm({
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-2 text-white/70">Game Title *</label>
        <input
          type="text"
          value={title}
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Rating (ESRB)</label>
          <select
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-white/70">Release Year</label>
          <input
            type="number"
      ...
      <div>
        <label className="block text-sm font-medium mb-2 text-white/70">Screenshots (CIDs)</label>
        <textarea
