...
export function SoftwareMetadataForm({
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Software Title *</label>
        <input
          type="text"
          value={title}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Version</label>
          <input
            type="text"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Repository URL</label>
        <input
          type="url"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Changelog</label>
        <textarea
