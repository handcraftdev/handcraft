...
export function ArtworkMetadataForm({
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Artwork Title *</label>
        <input
          type="text"
          value={title}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Medium</label>
          <select
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Width</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Height</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Year Created</label>
          <input
            type="number"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Edition</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Artist Statement</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5 text-white/70">Provenance</label>
        <textarea
