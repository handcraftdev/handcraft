...
export function PhotoMetadataForm({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Location</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5 text-white/70">Date Taken</label>
          <input
            type="date"
